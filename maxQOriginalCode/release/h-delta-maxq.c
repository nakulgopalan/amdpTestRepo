...
int impTFalse(DeltaTaxiState & state, ActualParameterList & apl)
{
  return 0;
}
...
int impTTrue(DeltaTaxiState  & state, ActualParameterList & apl)
{
  return 1;
}
Predicate TTrue(
...
int impTAtTarget(DeltaTaxiState  & state, ActualParameterList & apl)
{
...
QNode * PolicyNavigate(DeltaTaxiState & state,
...
int impTHolding(DeltaTaxiState  & state, ActualParameterList & apl)
{
...
QNode * PolicyGet(DeltaTaxiState & state,
		  ActualParameterList & apl,
		  ActualParameterList & cpl)
{
...
int impTNotHolding(DeltaTaxiState  & state, ActualParameterList & apl)
{
...
int impTNotHoldingAtDestination(DeltaTaxiState  & state, ActualParameterList & apl)
{
...
QNode * PolicyPut(DeltaTaxiState & state,
		  ActualParameterList & apl,
		  ActualParameterList & cpl)
{
...
QNode * PolicyRoot(DeltaTaxiState & state,
		   ActualParameterList & apl,
		   ActualParameterList & cpl)
{
...
int impTSimulationTerminatedAndPassengerDelivered(DeltaTaxiState  & state, ActualParameterList & apl)
{
...
int impTSimulationTerminated(DeltaTaxiState  & state, ActualParameterList & apl)
{
